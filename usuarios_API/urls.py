...
urlpatterns = [
    ...
    url(r'^ApoyaFem/(?P<pk>[1-9][0-9]*)',views.usuarioApoyaFemViewDetail.as_view()),
    ...
    url(r'^Abogado/(?P<pk>[1-9][0-9]*)$',views.usuarioAbogadoViewDetail.as_view()),
    ...
    url(r'^Psicologo/(?P<pk>[1-9][0-9]*)$',views.usuarioPsicologoViewDetail.as_view()),
